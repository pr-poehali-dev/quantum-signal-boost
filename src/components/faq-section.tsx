  ...
  const faqs = [
    {
      ...
      answer:
        "Да, это реальный заработок. DonPatchYYeasymoney работает по простой модели: рекламодатели платят за просмотры, и мы делим эту сумму пополам — 50% получаешь ты, 50% — платформа. Никаких скрытых условий.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Нет. Регистрация и использование DonPatchYYeasymoney полностью бесплатны. Никаких взносов, депозитов или подписок. Ты просто смотришь рекламу и получаешь деньги.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Абсолютно! DonPatchYYeasymoney работает на телефоне и в браузере. Смотри рекламу в свободное время: утром, в перерывах, в транспорте. Это полностью гибкий дополнительный доход.",
    },
    {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto font-space-mono">
            Отвечаем честно на всё, что вас интересует о платформе DonPatchYYeasymoney.
          </p>
        </div>
